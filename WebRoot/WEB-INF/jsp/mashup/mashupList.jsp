            ...
            <div class="col-12">
                <div class="main__title">
                    ...
                    <div class="main__title-wrap">
                        <!-- search -->
                        <form action="${ctx}/mashup/mashupList" class="main__title-form">
                            <input type="text" placeholder="Find mashups .." name="searchMashup">
                            <button type="submit">
...
<%--                            <th>ACTIONS</th>--%>
                        ...
                        <c:forEach items="${pagers.datas}" var="data" varStatus="l">
                            <tr>
                                <td><div class="main__table-text main__table-text--green">${data.mashup_id}</div></td>
                                <td><div class="main__table-text">${data.mashup_name}</div></td>
<%--                                <a href="${ctx}/mashup/mashupView?id=${data.mashup_id}">${data.mashup_name}</a>--%>
                                <c:if test="${data.mashup_tags==null}">
                                    <td><div class="main__table-text">NULL</div></td>
                                </c:if>
                                <c:if test="${data.mashup_tags!=null}">
                                    <td><div class="main__table-text">${data.mashup_tags}</div></td>
                                </c:if>

                                <c:if test="${data.mashup_apis==null}">
                                    <td><div class="main__table-text">NULL</div></td>
                                </c:if>
                                <c:if test="${data.mashup_apis!=null}">
                                    <td><div class="main__table-text">${data.mashup_apis}</div></td>
                                </c:if>
...
<%--                                </td>--%>
            ...
            <div class="col-12">
                <div class="paginator">
                    <!--分页开始-->
                    <pg:pager url="${ctx}/mashup/mashupList" maxIndexPages="20" items="${pagers.total}" maxPageItems="20" export="curPage=pageNumber">
