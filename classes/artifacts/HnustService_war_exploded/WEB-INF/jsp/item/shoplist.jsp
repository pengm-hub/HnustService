...
<div class="width1200 center_yh hidden_yh font14" style="height: 40px;line-height: 40px;">
    <span>当前位置：</span><a href="${ctx}/login/uIndex" class="c_66">首页</a>><a href="#" class="c_66">列表</a>
</div>
    ...
    <ul class="listSs">
        <c:forEach items="${pagers.datas}" var="data" varStatus="l">
            <li>
                ...
                <h1 class="spName">${data.name}</h1>
                <p class="center_yh block_yh hidden_yh" style="width: 202px;">
                    <font class="left_yh red font16">作者：${data.price}</font>
                </p>
                <div class="wCa">
