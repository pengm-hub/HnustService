...
<div class="panel admin-panel">
    <div class="panel-head" id="add">
        <strong><span class="icon-pencil-square-o">作品维护</span> </strong>
    </div>
    <div class="body-content">
        <form action="${ctx}/item/exUpdate" method="post" class="form-x" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" name="name" data-validate="required:请输入作品名称" value="${obj.name}"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" name="price" data-validate="required:请输入作者名称"  value="${obj.price}"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
