        ...
        <tr>
            <td colspan="8">
                <div class="pagelist">
                    <!--
                    分页开始
                    export="curPage=pageNumber"：在Pager标签里，可以暴露出来的变量有pageOffset及pageNumber
                    把pageNumber的值暴露出来，并赋给一个叫CurrentPage的变量，这个变量将被保存到Request中，在Jsp或Java中可以得到。
                    -->
                    <pg:pager url="${ctx}/itemCategory/findBySql" maxIndexPages="50" items="${pagers.total}" maxPageItems="10" export="curPage=pageNumber">
                        <pg:last>
