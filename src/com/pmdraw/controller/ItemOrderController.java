package com.pmdraw.controller;

import com.alibaba.fastjson.JSONObject;
import com.pmdraw.base.BaseController;
import com.pmdraw.po.*;
import com.pmdraw.service.*;
import com.pmdraw.utils.Consts;
import com.pmdraw.utils.Pager;
...
public class ItemOrderController extends BaseController {
    ...
    public String my(Model model, HttpServletRequest request){
        ...
        //全部作品
        String sql = "select * from item where price="+userId+" and isDelete=0 order by id desc";
        List<Item> all = itemService.listBySqlReturnEntity(sql);

        //正在审核
        String sql2 = "select * from item where price="+userId+" and isExamine=0 and isDelete=0 order by id desc";
        List<Item> dfh = itemService.listBySqlReturnEntity(sql2);

        //审核成功
        String sql3 = "select * from item where price="+userId+" and isExamine=1 and isDelete=0 order by id desc";
        List<Item> yqx = itemService.listBySqlReturnEntity(sql3);
